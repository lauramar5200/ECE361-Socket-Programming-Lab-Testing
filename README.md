...
Python test script for Lab 3 Assignment 1 to auto-create a number of clients to connect to the tcp server.
...
---RUNNING---
1) Depnding on how you implement your lab, ensure the server is running. I've been running everything in a terminal, so run something like: python3 server.py
2) Once it's running, then you can run this script. In another terminal, run: python3 testTCP.py
